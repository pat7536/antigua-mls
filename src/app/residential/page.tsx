...
export const metadata: Metadata = {
  ...
  description: 'Discover beautiful homes, villas, and condos for sale in Antigua & Barbuda. Browse our residential property listings with detailed photos, prices, and locations.',
  openGraph: {
    title: 'Residential Real Estate in Antigua | Antigua MLS',
    description: 'Discover beautiful homes, villas, and condos for sale in Antigua & Barbuda. Browse our residential property listings with detailed photos, prices, and locations.',
    type: 'website',
