...
export default function PropertyDetailPage() {
  ...
  if (images && images.length > 0) {
    ...
    const additionalImages = images.filter(img => !mainImageIds.includes(img.id));
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-lg">{Address || 'Address not provided'}</span>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {Bedrooms !== undefined && (
                    <div className="text-center">
                      ...
                      <div className="text-gray-600">Bedroom{Bedrooms !== 1 ? 's' : ''}</div>
                    </div>
                  )}
                  ...
                  {Bathrooms !== undefined && (
                    <div className="text-center">
                      ...
                      <div className="text-gray-600">Bathroom{Bathrooms !== 1 ? 's' : ''}</div>
                    </div>
                  )}
                  ...
                  {squareFootage && (
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold text-gray-900">{squareFootage.toLocaleString()}</div>
                ...
                {contactInfo ? (
                  ...
                  <div className="mb-6">
                    <p className="text-gray-700 mb-4">
                      Get in touch with our team to learn more about this exceptional property or to schedule a viewing.
                    </p>
                  </div>
                )}
